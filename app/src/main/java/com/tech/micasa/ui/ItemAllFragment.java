...
import com.tech.micasa.databinding.FragmentItemAllBinding;
...
public class ItemAllFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getCategories();
        adapterSellItems = new AdapterSellItems(strings,getContext(),categories,true);

        binding.layoutItemaction.imgHeader.setOnClickListener(v -> {
            getActivity().onBackPressed();
        });

        binding.layoutItemaction.tvHeader.setText(R.string.service);
